...
Pequeña aplicación web desarrollada para la gestión de usuarios mediante un dashboard administrativo, con control de acceso según roles. 
...
Aplicación web desarrollada como práctica de maquetación y desarrollo frontend, basada en el diseño del sitio de Teleperformance, incorporando funcionalidades dinámicas con JavaScript. 
...
## 🖥️ Aplicativo Trendline 
Aplicación web desarrollada durante mi experiencia/prácticas, orientada a la gestión y difusión de información entre agentes, facilitando el acceso y la organización de datos relevantes dentro de la operación. 
